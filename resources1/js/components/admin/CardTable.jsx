...
const CardTable = ({ title, data, columns, color = "light" }) => {
    // data: array de objetos. columns: array de {Header: 'Nombre Col', accessor: 'nombre_propiedad'}
    ...
    const getCellValue = (row, col) => {
        if (typeof col === "string") {
            return row[col.toLowerCase().replace(/\s+/g, "_")]; // Intenta convertir "Nombre Col" a "nombre_col"
        }
